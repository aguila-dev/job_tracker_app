  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-8 sm:py-12">
      <div className="mb-8 text-center sm:mb-12">
        <h1 className="mb-2 text-3xl font-bold text-gray-800 sm:mb-4 sm:text-4xl">Contact Us</h1>
        <p className="text-base text-gray-600 sm:text-xl">We'd love to hear from you. Reach out with any questions or feedback.</p>
      </div>

      {/* Contact info for small screens - appears at the top */}
      <div className="mb-8 rounded-xl bg-white p-6 shadow-card md:hidden">
      ...
      <div className="grid gap-8 md:grid-cols-2">
        ...
        <div className="rounded-xl bg-white p-6 shadow-card sm:p-8">
          <h2 className="mb-4 text-xl font-bold text-gray-800 sm:mb-6 sm:text-2xl">Get in Touch</h2>
        ...
        {/* Contact info for larger screens - appears to the right */}
        <div className="hidden rounded-xl bg-white p-6 shadow-card sm:p-8 md:block">
          <h2 className="mb-6 text-xl font-bold text-gray-800 sm:text-2xl">Contact Information</h2>
          ...
          {/* Map section */}
          <div className="mt-8 rounded-lg bg-neutral p-4">
            <h3 className="mb-2 text-lg font-medium text-gray-800">Our Location</h3>
