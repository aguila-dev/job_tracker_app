...
const AppNavbar: React.FC = () => {
  ...
  const protectedLinks = NAVBAR_LINKS.filter(link => 
    link.active && (isAuthenticated ? true : !link.requiresAuth)
  )
        ...
        <div className="flex h-full flex-col">
          ...
          <div className="flex flex-1 flex-col items-center justify-center space-y-4 p-4">
            ...
            <div className="my-4 w-full border-t border-gray-200 pt-4">
              <p className="mb-2 text-center text-sm font-medium text-gray-500">Public Pages</p>
        ...
        <div className="flex h-full flex-col">
          ...
          <div className="mt-auto">
            <div className="mb-4 mt-8 border-t border-gray-200 pt-4">
              <p className="mb-2 text-sm font-medium text-gray-500">Public Pages</p>
              {publicLinks.map((link) => (
                <NavLink
                  key={link.name}
                  to={link.path}
